...
class RE4ModUpdater(ctk.CTk):
    ...
    def apply_updater_update(self):
        ...
        batch_content = (
            ...
            "REM Margen mas generoso antes de abrirlo: el antivirus escaneando\r\n"
            "REM el .exe recien movido interfiere con la auto-extraccion de\r\n"
            "REM PyInstaller si se lanza demasiado pronto (2s no alcanzaba).\r\n"
